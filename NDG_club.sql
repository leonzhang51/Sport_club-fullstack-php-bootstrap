...
--
-- Host: localhost:8889
-- Generation Time: Feb 05, 2019 at 06:55 PM
...
(9, 'Full body', 'musculation', 19, 3),
(10, 'Split body', 'musculation', 14, 3),
(11, 'Cross fit', 'musculation', 24, 3),
(12, 'Méthode Hiit', 'musculation', 28, 3),
(13, 'Méthode Lafay', 'musculation', 9, 3),
(14, 'Muscu TRX', 'musculation', 12, 3),
(15, 'Prise de masse', 'musculation', 13, 3),
(16, 'Méthode VIPR', 'musculation', 9, 3),
...
(33, 'Basket ados', 'basketball', 14, 6),
(34, 'basket enfants', 'basketball', 19, 6),
...
(39, 'arbitrage', 'basketball', 10, 6),
(40, 'Fitness débutant', 'fitness', 35, 7),
(41, 'Fitness intermédiaire', 'fitness', 22, 7),
(42, 'fitness avancé', 'fitness', 15, 7),
(43, 'Post-partum', 'fitness', 14, 7),
(44, 'Femmes enceintes', 'fitness', 13, 7),
(45, 'fitness ados', 'fitness', 20, 7),
(46, 'fitness yoga', 'fitness', 14, 7),
(47, 'fitness seniors', 'fitness', 20, 7),
(49, 'Post Partum', 'natation', 12, 4);
...
(78, 66, 33, '2019-02-03', 'pending'),
(79, 66, 34, '2019-02-03', 'pending'),
(81, 66, 13, '2019-02-04', 'pay'),
(82, 66, 12, '2019-02-04', 'pay'),
(83, 66, 15, '2019-02-04', 'pay'),
(84, 66, 16, '2019-02-04', 'pay'),
(85, 66, 9, '2019-02-04', 'pay'),
(86, 66, 11, '2019-02-04', 'pay'),
(87, 66, 10, '2019-02-04', 'pay'),
(88, 66, 14, '2019-02-04', 'pay'),
(89, 64, 12, '2019-02-04', 'pay');
...
ALTER TABLE `activites`
  ADD PRIMARY KEY (`id_activite`) USING BTREE,
...
--
ALTER TABLE `activites`
  MODIFY `id_activite` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `inscriptions`
  MODIFY `id_inscription` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
