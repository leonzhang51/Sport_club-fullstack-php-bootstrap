 ...
 * @brief       Page @b Basketball du site.
...
if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['fonction']))
{
    ...
    $fonction= $_POST['fonction']; /** Permet de sélectionner via le select la requête MySql adéquate.*/
...
<div class="container-activites biopic img-fluid">
    <img src="./images/basket_teacher.jpg" class="basket img-fluid">
    <div class="text-bio">
        <h3 class="nom">Tony</h3>
        <div class="trait"></div>
        <h4>Expert (ambidextre) en basket</h4>
...
<div class="container-activites img-fluid">
    <img src="images/basket_background_.jpg" class="background img-fluid">
    <div class="text-activites">
        <h3>Enfants de la balle</h3>
