...
<div class="container-activites biopic img-fluid " style="">
    <img src="./images/fitness_teacher2.jpg" alt="photo du moniteur de l'activité sportive" class="fitness img-fluid">
    <div class="text-bio">
        <h3 class="nom">Charlize</h3>
        <div class="trait"></div>
        <h4>prof (dynamique) de fitness</h4>
...
<div class="container-activites img-fluid">
    <img class="background img-fluid" src="./images/action-active-activity-1671218.jpg" alt="photo d'illustration"class="img-fluid">
    <div class="text-activites">
        <h3>On vous déroule le tapis</h3>
