var courrielExp = /[^@]+@[^\.]+\..+$/; // expression régulière courriel //
        ...
        $(document).ready(function() { 
            $('#envoyer').click(function() { /** Lancement du script au clic sur le bouton envoyer. */
            ...
            $('#croix').click(function() { /** Réinitialisation des champs à la fermeture de la boîte de dialogue. */
                $('#erreurbis2').text('');
                $('#erreurbis2').css({
                    "display": "none",
                    "background-color": "#7fceff"
