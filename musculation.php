...
/**
 * @file        musculation.php.
 * @author      Leon Zhang .
 * @version     1.0.
 * @date        30 janvier 2019.
 * @brief       Page @b Musculation du site.
 ...
 *              comporte aussi un lien renvoyant vers une page d'@b inscription
 *              pour l'utilisateur non inscrit.
 */
...
<div class="container-activites biopic img-fluid">
    <img  src="./images/workout_teacher%20copie.jpg" class=" muscu img-fluid">
    <div class="text-bio">
        <h3 class="nom">Brad</h3>
        <div class="trait"></div>
        <h4>Prof de musculation</h4>
...
<div class="container-activites img-fluid">
    <img src="images/musculation_background.jpg" class="background img-fluid">
    <div class="text-activites">
        <h3>À chacun sa fonte</h3>
