...
<div class="container-activites biopic img-fluid">
    <img class= "img-fluid natation" src="./images/natation_teacher.jpg">
    <div class="text-bio">
        <h3 class="nom">Laure</h3>
        <div class="trait"></div>
        <h4>Expert (relax) en natation</h4>
        <p>Contrary to popular belief, Lorem Ipsum is not simply
            random text. It has roots in a piece of classical Latin
            literature from 45 BC, making it over 2000 years old.
            Richard McClitock,Contrary to popular belief.</p>
...
<div class="container-activites img-fluid">
    <img src="images/natation_background_.jpg" class="background img-fluid">
    <div class="text-activites">
        <h3>Le bonheur en immersion</h3>
<!--        <div class="trait-activite"></div>-->
    ...
    <script src="js/natation.js"></script>
