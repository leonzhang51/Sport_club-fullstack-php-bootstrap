...
<header>
    ...
    <div class="container-activites biopic img-fluid">
        <img src="./images/yoga_teacher.jpg" class="yoga img-fluid">
        <div class="text-bio">
            <h3 class="nom">Julien</h3>
            <div class="trait"></div>
            <h4>moniteur de yoga</h4>
            <p class="">Contrary to popular belief, 
    ...
    <div class="container-activites img-fluid">
        <img src="images/yoga3.jpg" class="background img-fluid">
        <div class="text-activites">
            <h3>À chacun son yoga</h3>
